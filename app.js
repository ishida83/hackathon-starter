...
app.get('/api/wechat/open_id', (req, res, next) => {
  let { code } = req.query;
  let url = 'https://api.weixin.qq.com/sns/jscode2session?appid=wx3cac99d02c940f34&secret=e39e366411f47de5da88425329c37e95&js_code={JSCODE}&grant_type=authorization_code';
